...
public class BookDialog extends JDialog {
	...
	public BookDialog(book b,final String name) {
		...
		this.setTitle(Book.getB_name()+"的基本信息");
		...
		ImageIcon img=new ImageIcon("C://Users/Administrator/Desktop/mylibrary/book/"+b.getB_name()+".jpg");
		//设置照片大小
		...
		ImageIcon img2=new ImageIcon("C://Users/Administrator/Desktop/mylibrary/Code/"+b.getB_name()+".png");
		//设置照片大小
		...
		//书名
		textField = new JTextField(Book.getB_name());
		textField.setBounds(376, 39, 110, 24);
		getContentPane().add(textField);
		textField.setColumns(10);
		
		//作者
		textField_1 = new JTextField(Book.getB_writer());
		textField_1.setColumns(10);
		textField_1.setBounds(376, 100, 110, 24);
		getContentPane().add(textField_1);
		
		//数量
		String nums=Book.getB_num().toString();
		...
		//出版社
		textField_3 = new JTextField(Book.getB_publish());
		textField_3.setColumns(10);
		textField_3.setBounds(376, 235, 110, 24);
		getContentPane().add(textField_3);
		
		//日期
		textField_4 = new JTextField(Book.getBr_date());
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//查询并修改阅读记录
				lookrecord l1=new lookrecord();
				l1.sendbook(name2, Book.getB_name());
