...
/*
 *该类的功能以及特点描述：超市管理系统查询（下架）输入商品Id的对话框
 ...
 *最后更改日期：
 */
public class MidMerchandiseDialog extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1069591283883577945L;
	private final JPanel contentPanel = new JPanel();

	private JTextField textField;
	public MidMerchandiseDialog(String Ord) {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String MerchaID=textField.getText().trim();
				...
				else
				{
					...
					Merchandise m=MerchandiseDao.getMerchandiseDao().lookMerchandise(MerchaID);
					...
					if(m!=null)
					{
						...
						new MerchandiseDailog(m).setVisible(true);
						dispose();
		...
		JLabel lblvip_1 = new JLabel(Ord+"商品");
